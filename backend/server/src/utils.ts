...
export const renameFile = async (
  ...
  const res = await fetch(`https://storage.sairamesh-pragada.workers.dev/api/rename`, {
    method: "POST",
    headers: {
...
export const saveFile = async (fileId: string, data: string) => {
  const res = await fetch(`https://storage.sairamesh-pragada.workers.dev/api/save`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export const createFile = async (fileId: string) => {
  const res = await fetch(`https://storage.sairamesh-pragada.workers.dev/api`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export const getProjectSize = async (id: string) => {
  const res = await fetch(
    `https://storage.sairamesh-pragada.workers.dev/api/size?virtualboxId=${id}`
  );
...
export const getFolder = async (folderId: string) => {
  const res = await fetch(
    `https://storage.sairamesh-pragada.workers.dev/api?folderId=${folderId}`
  );
